...
# Objetivo: Calcular os valores preditos e plotar um gráfico 3d relacionando o log(salário) heteroscedástico
...
# output: grafico3d_educ_exp_log(salario)_hetero
#######################################################
...
htmlwidgets::saveWidget(
  grafico3d, file.path(dir_output, "grafico3d_educ_exp_log(salario)_hetero.html"))
