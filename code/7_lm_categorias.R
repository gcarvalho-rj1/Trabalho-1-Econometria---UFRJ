...
# Objetivo: Rodar uma regressão de log(salário) em anos de estudo, experiência, o quadrado da experiência, dummies regionais,
# dummy de sexo, dummy de raça
...
regress_4 <- lm(log_wage_homo ~ education + experience + experience2 + north + northeast + south + centerwest +
                male + white, data = data
)

save(regress_4, file = file.path(dir_tmp, "regress_4.RData"))
