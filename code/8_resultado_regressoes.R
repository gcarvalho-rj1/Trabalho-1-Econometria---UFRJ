...
stargazer(regress_4, type = "html", out = file.path(dir_output, "regress_4_tabela.html"),          
  title = "Resultados da Regressão: Log do Salário",
  align = TRUE, dep.var.labels = "log_wage_homo", covariate.labels = 
